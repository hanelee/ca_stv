...
\subsection{Pros}
\begin{itemize}
    \item[\bf{Districts:}] STV can be used with or without districts. It is flexible enough to be used 
...
\begin{itemize}
    ...
    \item[\bf{Voter burden:}] As a voting system, STV technically requires that each voter provides 
    ...
    \item[\bf{Vote leakage:}] If a voter does not complete their ballot, it is possible that 
