...
\subsection{History in other countries}

\section{Pros and Cons}
STV can be used with or without districts.
...
Note that the STV algorithm \emph{technically}requires complete ballots as input.
That is, each ballot should list every candidate in exactly one ranking position. 
\todo{talk about how to handle incomplete ballots}
